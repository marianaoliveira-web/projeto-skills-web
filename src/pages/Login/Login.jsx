...
export function Login() {
    const [login, setLogin] = useState(() => localStorage.getItem('@app:login') || '');
    const [senha, setSenha] = useState(() => localStorage.getItem('@app:senha') || '');
    ...
    return (
        <div className={styles.container}>
            <div className={styles.card}>
                ...
                {erro && <p style={{ color: 'red', marginBottom: '16px', fontSize: '0.85rem' }}>{erro}</p>}
